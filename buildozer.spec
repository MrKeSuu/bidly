...
presplash.filename = %(source.dir)s/app/bidly-loading.png

# (str) Icon of the application
icon.filename = %(source.dir)s/app/bidly-icon-nomargin.png
...
p4a.hook = app/camerax_provider/gradle_options.py
